...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AchievementGroup.order'
        db.add_column('achievements_achievementgroup', 'order', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)

        try:
            group = orm['achievements.AchievementGroup'].objects.get(pk='general')
            group.order = 0
            group.save()
        except:
            pass # ignore
        ...
        try:
            group = orm['achievements.AchievementGroup'].objects.get(pk='positions')
            group.order = 2
            group.save()
        except:
            pass # ignore
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AchievementGroup.order'
        db.delete_column('achievements_achievementgroup', 'order')
