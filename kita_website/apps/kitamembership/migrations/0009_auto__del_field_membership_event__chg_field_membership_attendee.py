...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'kitamembership_membership', 'event_id')


        # Changing field 'Membership.attendee'
        db.alter_column(u'kitamembership_membership', 'attendee_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['events.Attend']))

    def backwards(self, orm):
        # Adding field 'Membership.event'
        db.add_column(u'kitamembership_membership', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Membership.attendee'
        db.alter_column(u'kitamembership_membership', 'attendee_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Attend'], null=True))
