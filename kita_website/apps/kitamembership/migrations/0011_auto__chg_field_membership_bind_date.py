...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Membership.bind_date'
        db.alter_column(u'kitamembership_membership', 'bind_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Membership.bind_date'
        db.alter_column(u'kitamembership_membership', 'bind_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'kitamembership.membership': {
            ...
            'bind_date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
