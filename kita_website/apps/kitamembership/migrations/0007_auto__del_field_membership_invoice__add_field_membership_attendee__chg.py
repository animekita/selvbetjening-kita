...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'membership', fields ['user', 'invoice']
        db.delete_unique(u'kitamembership_membership', ['user_id', 'invoice_id'])

        # Deleting field 'membership.invoice'
        db.delete_column(u'kitamembership_membership', 'invoice_id')

        # Adding field 'Membership.attendee'
        db.add_column(u'kitamembership_membership', 'attendee',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['events.Attend'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Membership.user'
        db.alter_column(u'kitamembership_membership', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.SUser']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'membership.invoice'
        raise RuntimeError("Cannot reverse this migration. 'membership.invoice' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'membership.invoice'
        db.add_column(u'kitamembership_membership', 'invoice',
                      self.gf('models.ForeignKey')(Invoice, blank=True),
                      keep_default=False)

        # Deleting field 'Membership.attendee'
        db.delete_column(u'kitamembership_membership', 'attendee_id')


        # Changing field 'Membership.user'
        db.alter_column(u'kitamembership_membership', 'user_id', self.gf('models.ForeignKey')(User))
        # Adding unique constraint on 'membership', fields ['user', 'invoice']
        db.create_unique(u'kitamembership_membership', ['user_id', 'invoice_id'])
    ...
    models = {
        ...
        u'kitamembership.membership': {
            ...
            'attendee': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['events.Attend']", 'null': 'True', 'blank': 'True'}),
        ...
        u'kitamembership.yearlyrate': {
            'Meta': {'object_name': 'YearlyRate'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rate': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '2'}),
