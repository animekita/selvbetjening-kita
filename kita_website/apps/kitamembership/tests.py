...
class MembershipModelTestCase(TestCase):
    ...
    def test_full_payment_inactive(self):
        user = Database.new_user()
        invoice = Membership.objects.select_membership(
            user,
            MembershipType.FULL,
            date=self.date_inactive)
    ...
    def test_srate_payment_inactive(self):
        ...
        invoice = Membership.objects.select_membership(
            ...
            date=self.date_inactive + timedelta(minutes=1))
    ...
    def test_srate_payment_passive(self):
        ...
        invoice = Membership.objects.select_membership(
            user,
            MembershipType.SRATE,
            date=self.date_passive + timedelta(minutes=1))
    ...
    def test_srate_payment_active(self):
        ...
        invoice = Membership.objects.select_membership(
            user,
            MembershipType.SRATE,
            date=self.date_active + timedelta(minutes=1))
    ...
    def test_full_payment_passive_no_date(self):
        ...
        invoice = Membership.objects.select_membership(
            user,
            MembershipType.FULL,
            date=datetime(today.year - 1, today.month, today.day, 0, 0, 0))
    ...
    def test_no_payments(self):
        ...
        self.assertFalse(Membership.objects.is_member(user))
    ...
    def test_full_payment(self):
        ...
        self.assertTrue(Membership.objects.is_member(user))
    ...
    def test_first_rate_event(self):
        ...
        self.assertFalse(Membership.objects.is_member(user))
        self.assertTrue(Membership.objects.is_member(user, event=event))
...
class MembershipFormTestCase(TestCase):
    ...
    def test_save(self):
        ...
        self.assertTrue(Membership.objects.is_member(self.user1))
